...
function BoomboxIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M6 9.5h12'></path>
      <path
        stroke={linearColor}
        strokeWidth='1.5'
      ...
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M8 13v2M18.121 13.879l-1.414 1.414'></path>
    </SvgIcon>
  );
}
