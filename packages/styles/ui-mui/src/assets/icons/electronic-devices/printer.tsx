...
function PrinterIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M9 10H6M19 14H5'></path>
      <path
        fill={linearColor}
      ...
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M15 16.5H9M13 19H9'></path>
    </SvgIcon>
  );
}
