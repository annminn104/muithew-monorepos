...
function TurntableMusicNoteIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M22 15a3 3 0 01-3-3' />
      <path stroke={linearColor} strokeWidth='1.5' d='M9 12a3 3 0 116 0 3 3 0 01-6 0z' />
    </SvgIcon>
  );
}
