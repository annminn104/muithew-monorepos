...
function AirbudsLeftIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.676' d='M8 5v3'></path>
      <circle cx='5.5' cy='5.5' r='5.5' stroke={linearColor} strokeWidth='1.5' transform='matrix(-1 0 0 1 21 11)' />
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M14 14v5h3'></path>
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M14 5.1A5.006 5.006 0 0117.9 9'></path>
    </SvgIcon>
  );
}
