...
function MouseCircleIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      <path stroke={linearColor} strokeWidth='1.5' d='M8 10a4 4 0 118 0v4a4 4 0 01-8 0v-4z'></path>
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M8.5 10h7M12 10V6'></path>
      <path
        fill={linearColor}
...
export default React.memo(MouseCircleIcon);
