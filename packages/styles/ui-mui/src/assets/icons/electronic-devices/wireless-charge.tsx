...
function WirelessChargeIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path fill={linearColor} d='M11.25 22a.75.75 0 001.5 0h-1.5zm0-1v1h1.5v-1h-1.5z'></path>
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M12.857 7L10 10h4l-2.857 3'></path>
      <path
        stroke={linearColor}
        strokeWidth='1.5'
