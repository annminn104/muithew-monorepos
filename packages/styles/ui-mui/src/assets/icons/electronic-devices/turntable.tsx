...
function TurntableIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M15 17l.894-.447A2 2 0 0017 14.763V10.5' />
      <rect width='8' height='8' x='6' y='8' stroke={linearColor} strokeWidth='1.5' rx='4' />
      <path stroke={linearColor} strokeWidth='1.5' d='M15.5 9a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0z' />
    </SvgIcon>
  );
}
