...
function PlusCircleIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeWidth='1.5' d='M9 11.8a.8.8 0 01.8-.8h4.4a.8.8 0 01.8.8v.2a3 3 0 11-6 0v-.2z' />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M13.5 11V9M10.5 11V9' />
    </SvgIcon>
  );
}
