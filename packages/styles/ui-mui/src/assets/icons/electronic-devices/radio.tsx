...
function RadioIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeWidth='1.5' d='M5 11a2 2 0 012-2h10a2 2 0 110 4H7a2 2 0 01-2-2zM9 17a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z' />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M15 11.5V13M13 17h5M6.5 6L15 2' />
    </SvgIcon>
  );
}
