...
function BluetoothIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path fill={linearColor} d='M5.57 14.886a.75.75 0 10.86 1.228l-.86-1.228zm.86 1.228l5-3.5-.86-1.228-5 3.5.86 1.228z' />
      <path fill={linearColor} d='M5.57 9.114a.75.75 0 01.86-1.228l-.86 1.228zm.86-1.228l5 3.5-.86 1.228-5-3.5.86-1.228z' />
    </SvgIcon>
  );
}
