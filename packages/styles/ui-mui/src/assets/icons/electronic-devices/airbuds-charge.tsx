...
function AirbudsChargeIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M18 16.5L17 18h2l-1 1.5'></path>
    </SvgIcon>
  );
}

export default React.memo(AirbudsChargeIcon);
