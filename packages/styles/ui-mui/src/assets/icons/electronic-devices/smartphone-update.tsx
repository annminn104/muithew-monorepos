  ...
  return (
    <SvgIcon {...props} className='linear'>
      <g clipPath='url(#clip0_9754_6705)'>
        ...
        />
        <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M15 19H9'></path>
      </g>
      <defs>
        <clipPath id='clip0_9754_6705'>
          <path fill={linearColor} d='M0 0H24V24H0z'></path>
        </clipPath>
      </defs>
    </SvgIcon>
  );
...
export default React.memo(SmartphoneUpdateIcon);
