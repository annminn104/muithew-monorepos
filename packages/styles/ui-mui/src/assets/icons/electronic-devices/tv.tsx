...
function TVIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M9 2l3 3.5L15 2M16 6v16' />
      <path fill={linearColor} d='M20 16a1 1 0 10-2 0 1 1 0 002 0zM20 12a1 1 0 10-2 0 1 1 0 002 0z' />
    </SvgIcon>
  );
}
