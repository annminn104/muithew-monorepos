...
function HeadphonesRoundSoundIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      <path stroke={linearColor} strokeWidth='1.5' d='M22 17v-5c0-5.523-4.477-10-10-10S2 6.477 2 12v6'></path>
      <path
        stroke={linearColor}
        strokeWidth='1.5'
