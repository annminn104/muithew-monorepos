...
function AirbudsCaseChargeIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M12 18l2-2.5h-4l2-2.5'></path>
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M7 9h10'></path>
    </SvgIcon>
  );
}

export default React.memo(AirbudsCaseChargeIcon);
