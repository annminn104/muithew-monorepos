...
function BluetoothWaveIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path fill={linearColor} d='M2.57 14.886a.75.75 0 10.86 1.228l-.86-1.228zm.86 1.228l5-3.5-.86-1.228-5 3.5.86 1.228z'></path>
      <path fill={linearColor} d='M2.57 9.114a.75.75 0 01.86-1.228l-.86 1.228zm.86-1.228l5 3.5-.86 1.228-5-3.5.86-1.228z'></path>
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M19 5s2 2.1 2 7-2 7-2 7M17 8s1 1.9 1 4-1 4-1 4'></path>
    </SvgIcon>
  );
}
