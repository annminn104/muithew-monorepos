...
function ServerPathIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M22 19h-8M2 19h8M12 17v-3' />
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M13 5h6M13 11h6' />
