...
function Server2Icon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M13.5 6H18M6 7V5M9 7V5M13.5 17H18M6 18v-2M9 18v-2'></path>
    </SvgIcon>
  );
}

export default React.memo(Server2Icon);
