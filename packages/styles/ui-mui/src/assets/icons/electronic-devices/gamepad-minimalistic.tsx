...
function GamepadMinimalisticIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M8.5 11v3M7 12.5h3' />
      <path
        stroke={linearColor}
        strokeWidth='1.5'
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M12 7V6a1 1 0 011-1h1a1 1 0 001-1V3' />
      <path fill={linearColor} d='M16 11a1 1 0 11-2 0 1 1 0 012 0zM18 14a1 1 0 11-2 0 1 1 0 012 0z' />
    </SvgIcon>
  );
}
