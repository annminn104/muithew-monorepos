...
function SmartphoneRotateOrientationIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeWidth='1.5' d='M10 17.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z' />
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M20.5 6.986L22 8c0-3.015-2.162-5.517-5-6' />
    </SvgIcon>
  );
}
