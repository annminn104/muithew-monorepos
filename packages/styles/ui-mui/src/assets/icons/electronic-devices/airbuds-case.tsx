...
function AirbudsCaseIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeWidth='1.5' d='M7 9a2 2 0 012-2h6a2 2 0 110 4H9a2 2 0 01-2-2zM21 9h-3.5M7 9H3'></path>
    </SvgIcon>
  );
}

export default React.memo(AirbudsCaseIcon);
