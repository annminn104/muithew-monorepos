...
function MouseIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      <path stroke={linearColor} strokeWidth='1.5' d='M10.5 8.5a1.5 1.5 0 013 0v2a1.5 1.5 0 01-3 0v-2z' />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M12 2v5' />
    </SvgIcon>
  );
}
