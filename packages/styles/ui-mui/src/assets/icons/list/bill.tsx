...
function BillIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M2 2h20'></path>
      <path
        stroke={linearColor}
        strokeWidth='1.5'
      ...
      ></path>
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M8.5 13h7M8.5 8h7'></path>
    </SvgIcon>
  );
}
