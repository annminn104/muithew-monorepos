...
function StarFailMinimalisticIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      ></path>
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M13.5 6.5L13 6M9.5 2.5l2 2M6.5 6.5L4 4M6 12l-1.5-1.5M2 8l.5.5'></path>
    </SvgIcon>
  );
}
