...
function UFO2Icon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      ></path>
      <circle cx='12' cy='12' r='1' fill={linearColor}></circle>
      <circle cx='7' cy='11' r='1' fill={linearColor}></circle>
      <circle cx='17' cy='11' r='1' fill={linearColor}></circle>
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M12 21v-3M18 20v-3M6 20v-3'></path>
    </SvgIcon>
  );
}
