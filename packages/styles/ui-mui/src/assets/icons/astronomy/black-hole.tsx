...
function BlackHoleIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M12 10c5 0 4.6 12-3 12M12.312 14c-5 0-4.6-12 3-12'></path>
      <path
        stroke={linearColor}
        strokeDasharray='2 2'
        strokeLinecap='round'
      ...
      ></path>
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M10 12.312c0-5 12-4.6 12 3M14 12c0 5-12 4.6-12-3'></path>
    </SvgIcon>
  );
}
