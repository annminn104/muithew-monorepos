...
function UFOIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      ></path>
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M12 16v3M5.5 15.5l-1 2M18.5 15.5l1 2'></path>
      <circle cx='12' cy='13' r='1' fill={linearColor}></circle>
      <circle cx='7' cy='12' r='1' fill={linearColor}></circle>
      <circle cx='17' cy='12' r='1' fill={linearColor}></circle>
    </SvgIcon>
  );
}
