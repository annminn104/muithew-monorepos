...
function UFO3Icon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      ></path>
      <circle cx='12' cy='12' r='1' fill={linearColor} transform='rotate(45 12 12)'></circle>
      <circle cx='9.172' cy='7.757' r='1' fill={linearColor} transform='rotate(45 9.172 7.757)'></circle>
      <circle cx='16.243' cy='14.828' r='1' fill={linearColor} transform='rotate(45 16.243 14.828)'></circle>
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M3.636 20.364l4.121-4.121M10 22l2.707-2.222M2 14l2.222-2.707'></path>
    </SvgIcon>
  );
}
