...
function UserMinusRoundedIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      <circle cx='12' cy='6' r='4' stroke={linearColor} strokeWidth='1.5' />
      <circle cx='17' cy='18' r='4' stroke={linearColor} strokeWidth='1.5' />
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M16 18h2' />
      <path
        stroke={linearColor}
        strokeWidth='1.5'
...
export default React.memo(UserMinusRoundedIcon);
