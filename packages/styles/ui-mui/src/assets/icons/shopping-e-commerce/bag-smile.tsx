...
function BagSmileIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M9 6V5a3 3 0 116 0v1M9.17 15a3.001 3.001 0 005.66 0' />
    </SvgIcon>
  );
}

export default React.memo(BagSmileIcon);
