...
function Cart4Icon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M3 11h18M10 14h4M18 9l-3-6M6 9l3-6' />
    </SvgIcon>
  );
}

export default React.memo(Cart4Icon);
