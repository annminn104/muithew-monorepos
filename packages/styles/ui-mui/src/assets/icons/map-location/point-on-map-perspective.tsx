...
function PointOnMapPerspectiveIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      <path
        ...
        strokeWidth={1.5}
      />
      <path d='M21 21L3 11' stroke={linearColor} strokeWidth={1.5} strokeLinecap='round' />
      <path d='M3.5 21L12 16' stroke={linearColor} strokeWidth={1.5} strokeLinecap='round' />
      <circle cx={17} cy={5} r={3} stroke={linearColor} strokeWidth={1.5} />
      <path d='M17 13L17 8' stroke={linearColor} strokeWidth={1.5} strokeLinecap='round' />
    </SvgIcon>
  );
}
