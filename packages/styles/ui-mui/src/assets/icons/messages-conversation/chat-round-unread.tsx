...
function ChatRoundUnreadIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      <circle cx='3' cy='3' r='3' stroke={linearColor} strokeWidth='1.5' transform='matrix(-1 0 0 1 22 2)'></circle>
      <path
        stroke={linearColor}
        strokeLinecap='round'
        strokeWidth='1.5'
