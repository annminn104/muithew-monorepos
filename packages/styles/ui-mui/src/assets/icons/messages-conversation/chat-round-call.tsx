...
function ChatRoundCallIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      ></path>
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M12 16V8M8 14v-4M16 14v-4'></path>
    </SvgIcon>
  );
}
