...
function SmileFileIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      ></path>
      <path stroke={linearColor} strokeWidth='1.5' d='M13 2.5V5c0 2.357 0 3.536.732 4.268C14.464 10 15.643 10 18 10h4'></path>
      <ellipse cx='17' cy='14.5' fill={linearColor} rx='1' ry='1.5'></ellipse>
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M9 17.5a5.408 5.408 0 006 0'></path>
      <ellipse cx='7' cy='14.5' fill={linearColor} rx='1' ry='1.5'></ellipse>
    </SvgIcon>
  );
}
