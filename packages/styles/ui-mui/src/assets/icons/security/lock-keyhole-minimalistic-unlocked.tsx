...
function LockKeyholeMinimalisticUnlockedIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M6 10V8a6 6 0 0111.811-1.5M12 14v4' />
    </SvgIcon>
  );
}
