...
function ArchiveDownIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M12 7v9m0 0l3-3.333M12 16l-3-3.333' />
    </SvgIcon>
  );
}

export default React.memo(ArchiveDownIcon);
