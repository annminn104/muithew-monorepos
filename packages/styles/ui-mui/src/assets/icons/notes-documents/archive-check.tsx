...
function ArchiveCheckIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M9.5 13.4l1.429 1.6 3.571-4' />
    </SvgIcon>
  );
}

export default React.memo(ArchiveCheckIcon);
