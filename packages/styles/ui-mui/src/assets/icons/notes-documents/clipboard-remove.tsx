...
function ClipboardRemoveIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      <path
        ...
        strokeWidth='1.5'
      />
      <path d='M14.5 11L9.50002 16M9.5 11L14.5 16' stroke={linearColor} strokeWidth='1.5' strokeLinecap='round' />
    </SvgIcon>
  );
}
