...
function ArchiveUpIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M12 21v-9m0 0l3 3.333M12 12l-3 3.333' />
      <path
        stroke={linearColor}
        strokeLinecap='round'
        strokeWidth='1.5'
...
export default React.memo(ArchiveUpIcon);
