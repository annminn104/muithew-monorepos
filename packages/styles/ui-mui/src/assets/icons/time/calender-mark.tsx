...
function CalenderMarkIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      <circle cx='16.5' cy='16.5' r='1.5' stroke={linearColor} strokeWidth='1.5' />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M2.5 9h19' />
    </SvgIcon>
  );
}

export default React.memo(CalenderMarkIcon);
