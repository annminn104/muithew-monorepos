...
function BatteryLowMinimalisticIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M7 9s.5.9.5 3-.5 3-.5 3M22 14v-4' />
    </SvgIcon>
  );
}

export default React.memo(BatteryLowMinimalisticIcon);
