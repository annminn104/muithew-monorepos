...
function CupMusicIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M13 10.5V5' />
      <circle cx='11.5' cy='10.5' r='1.5' stroke={linearColor} strokeWidth='1.5' />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M15 7a2 2 0 01-2-2' />
      <path
        stroke={linearColor}
        strokeWidth='1.5'
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M18 22H6' />
    </SvgIcon>
  );
}
