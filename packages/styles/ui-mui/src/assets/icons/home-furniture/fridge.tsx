...
function FridgeIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeLinejoin='round' strokeWidth='1.5' d='M17 21v1h-1v-1m-8 0v1H7v-1' />
      <path stroke={linearColor} strokeWidth='1.5' d='M20 11.5H4' />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M17 7v2M17 14v2' />
    </SvgIcon>
  );
}
