...
function SmartVacuumCleaner2Icon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      <path stroke={linearColor} strokeWidth='1.5' d='M15 9a3 3 0 11-6 0 3 3 0 016 0z'></path>
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M12 18v-2M2 22l2.5-2.5M22 22l-2.5-2.5'></path>
    </SvgIcon>
  );
}
