...
function RemoteControllerIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeWidth='1.5' d='M15 15.5a3 3 0 11-6 0 3 3 0 016 0z' />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M9 5.5h6' />
...
export default React.memo(RemoteControllerIcon);
