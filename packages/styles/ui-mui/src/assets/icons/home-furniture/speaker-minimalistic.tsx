...
function SpeakerMinimalisticIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeWidth='1.5' d='M16 14a4 4 0 11-8 0 4 4 0 018 0z' />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M10 6h4' />
    </SvgIcon>
  );
}
