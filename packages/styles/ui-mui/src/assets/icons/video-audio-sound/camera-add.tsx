...
function CameraAddIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      <path d='M15 13H9' stroke={linearColor} strokeWidth={1.5} strokeLinecap='round' />
      <path d='M12 10L12 16' stroke={linearColor} strokeWidth={1.5} strokeLinecap='round' />
      <path
        ...
        strokeWidth={1.5}
      />
      <path d='M19 10H18' stroke={linearColor} strokeWidth={1.5} strokeLinecap='round' />
    </SvgIcon>
  );
}
