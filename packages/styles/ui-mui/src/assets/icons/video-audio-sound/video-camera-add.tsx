...
function VideoCameraAddIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      <path
        ...
        strokeWidth={1.5}
      />
      <path d='M7 12H9.5M9.5 12H12M9.5 12V14.5M9.5 12V9.5' stroke={linearColor} strokeWidth={1.5} strokeLinecap='round' />
    </SvgIcon>
  );
}
