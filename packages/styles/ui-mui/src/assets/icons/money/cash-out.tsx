...
function CashOutIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M12 6v7m0 0l2-2.333M12 13l-2-2.333' />
      <path
        stroke={linearColor}
        strokeWidth='1.5'
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M5 17h14' />
    </SvgIcon>
  );
}
