...
function Safe2Icon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeWidth='1.5' d='M8 12a4 4 0 118 0 4 4 0 01-8 0z' />
      <path fill={linearColor} d='M13.5 12a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z' />
      <path stroke={linearColor} strokeWidth='1.5' d='M12 12V8M12 12l3.5 1.5M12 12l-3.5 1.5' />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M4.5 7v3M4.5 14v3' />
    </SvgIcon>
  );
}
