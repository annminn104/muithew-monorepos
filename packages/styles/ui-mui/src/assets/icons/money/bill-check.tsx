...
function BillCheckIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M9.5 10.4l1.429 1.6L14.5 8' />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M7.5 15.5h9' />
    </SvgIcon>
  );
}
