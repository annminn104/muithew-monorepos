...
function TagIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <circle cx='8.607' cy='8.879' r='2' stroke={linearColor} strokeWidth='1.5' transform='rotate(-45 8.607 8.879)' />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M11.542 18.5l6.979-6.98' />
    </SvgIcon>
  );
}
