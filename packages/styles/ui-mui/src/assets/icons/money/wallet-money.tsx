...
function WalletMoneyIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M6 10h4' />
      <path
        stroke={linearColor}
        strokeWidth='1.5'
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M6 6l3.735-2.477a3.237 3.237 0 013.53 0L17 6' />
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='2' d='M17.991 14h.01' />
    </SvgIcon>
  );
}
