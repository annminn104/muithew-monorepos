...
function CloudStormIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M6 22.385l4.286-3.692H6L10.286 15'></path>
    </SvgIcon>
  );
}

export default React.memo(CloudStormIcon);
