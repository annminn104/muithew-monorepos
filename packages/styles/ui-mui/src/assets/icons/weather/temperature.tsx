...
function TemperatureIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeWidth='1.5' d='M14.5 16.5a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z' />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M12 14V5' />
    </SvgIcon>
  );
}
