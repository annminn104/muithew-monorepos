...
function CallIncomingCancelRoundedIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M19 5l-4 4m0 0V6m0 3h3'></path>
      <path
        stroke={linearColor}
        strokeLinecap='round'
        strokeWidth='1.5'
...
export default React.memo(CallIncomingCancelRoundedIcon);
