...
function MoveToFolderIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      ></path>
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M2 15h11m0 0l-4.125-3M13 15l-4.125 3'></path>
    </SvgIcon>
  );
}

export default React.memo(MoveToFolderIcon);
