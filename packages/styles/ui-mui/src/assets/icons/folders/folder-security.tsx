...
function FolderSecurityIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      ></path>
      <circle cx='12' cy='13' r='2' stroke={linearColor} strokeWidth='1.5'></circle>
      <path fill={linearColor} d='M11.25 17.5a.75.75 0 001.5 0h-1.5zm0-2.5v2.5h1.5V15h-1.5z'></path>
    </SvgIcon>
  );
}

export default React.memo(FolderSecurityIcon);
