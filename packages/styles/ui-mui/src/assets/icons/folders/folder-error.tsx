...
function FolderErrorIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      ></path>
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M10.5 15l3-3m0 3l-3-3'></path>
    </SvgIcon>
  );
}

export default React.memo(FolderErrorIcon);
