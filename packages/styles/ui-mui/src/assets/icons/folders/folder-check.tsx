...
function FolderCheckIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      ></path>
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M10 13.5l1.333 1.5L14 12'></path>
    </SvgIcon>
  );
}

export default React.memo(FolderCheckIcon);
