...
function FolderWithFilesIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M18 10h-5'></path>
      <path stroke={linearColor} strokeWidth='1.5' d='M10 3h6.5c.464 0 .697 0 .892.026a3 3 0 012.582 2.582c.026.195.026.428.026.892'></path>
      <path
        stroke={linearColor}
        strokeWidth='1.5'
