...
function RemoveFolderIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M14 14h-4'></path>
      <path
        stroke={linearColor}
        strokeWidth='1.5'
...
export default React.memo(RemoveFolderIcon);
