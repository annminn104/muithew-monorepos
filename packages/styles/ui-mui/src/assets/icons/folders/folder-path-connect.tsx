...
function FolderPathConnectIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M16.5 7.5h-3'></path>
      <path
        stroke={linearColor}
        strokeWidth='1.5'
      ...
      ></path>
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M22 20h-8M2 20h8M12 18v-3'></path>
      <circle cx='12' cy='20' r='2' stroke={linearColor} strokeWidth='1.5'></circle>
    </SvgIcon>
  );
}
