...
function NotificationBellOffIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M10 9h4l-4 4h4' />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M7.5 19c.655 1.748 2.422 3 4.5 3s3.845-1.252 4.5-3' />
    </SvgIcon>
  );
}
