...
function BenzeneRingIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M5 8L2 6M19 8l3-2M5 16l-3 2' />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M12 16.884l4-2.384' />
    </SvgIcon>
  );
}
