...
function PillsIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M14.5 6.5L13 5' />
      <path stroke={linearColor} strokeWidth='1.5' d='M6.73 10.135a6 6 0 107.143 7.098' />
    </SvgIcon>
  );
}
