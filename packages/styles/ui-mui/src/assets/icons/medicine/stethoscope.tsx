...
function StethoscopeIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      <path stroke={linearColor} strokeWidth='1.5' d='M9 14.235V17a5 5 0 005 5h.882a4.12 4.12 0 003.964-3' />
      <path
        stroke={linearColor}
        strokeLinecap='round'
        strokeWidth='1.5'
      ...
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M12 2v2M6 2v2' />
    </SvgIcon>
  );
}
