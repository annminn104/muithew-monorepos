...
function HeartPulse2Icon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      <path
        ...
        strokeLinecap='round'
        strokeWidth='1.5'
        d='M21 12h-2.364c-.658 0-.987 0-1.278.13-.291.13-.512.374-.952.863l-1.03 1.144c-.36.401-.541.602-.77.597-.23-.005-.401-.213-.744-.63l-3.529-4.276c-.32-.388-.48-.582-.697-.595-.217-.013-.4.16-.764.508L7.37 11.172c-.43.409-.644.613-.912.72C6.19 12 5.893 12 5.3 12H3'
      ></path>
      <path
        fill={linearColor}
...
export default React.memo(HeartPulse2Icon);
