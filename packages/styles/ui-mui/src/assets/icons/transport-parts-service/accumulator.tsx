...
function AccumulatorIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeWidth='1.5' d='M9 13.5H6M18 13.5h-1.5m0 0H15m1.5 0V12m0 1.5V15' />
    </SvgIcon>
  );
}
