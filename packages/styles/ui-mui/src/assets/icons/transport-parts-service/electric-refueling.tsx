...
function ElectricRefuelingIcon({ linearColor = '#1C274C', ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className='linear'>
      ...
      />
      <path stroke={linearColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M9.5 10L8 12.5h3L9.5 15' />
      <path
        stroke={linearColor}
        strokeLinecap='round'
        strokeWidth='1.5'
