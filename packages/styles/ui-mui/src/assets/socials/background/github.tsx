...
function SocialGithubBgIcon({ ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} viewBox='0 0 24 24'>
      <path fill='#1F1F1F' d='M24 12c0 6.627-5.373 12-12 12S0 18.627 0 12 5.373 0 12 0s12 5.373 12 12z' />
      <path
        fill='#fff'
...
export default SocialGithubBgIcon;
